        ...
        {!isLoading && !user ? (
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="text-center">
              ...
              <div className="mt-8 flex justify-center">
                ...
                <div className="ml-3 inline-flex">
                  <a
                    href="/auth"
                    className="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-primary bg-background hover:bg-muted"
                  >
                    Sign In
                  </a>
                </div>
            ...
            <div className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
              <div className="pt-6">
                <div className="flow-root bg-card rounded-lg px-6 pb-8 shadow">
                  <div className="-mt-6">
                    <div>
                    ...
                    <h3 className="mt-8 text-lg font-medium text-foreground tracking-tight">Create Custom Quizzes</h3>
              ...
              <div className="pt-6">
                <div className="flow-root bg-card rounded-lg px-6 pb-8 shadow">
                  <div className="-mt-6">
                    ...
                    <h3 className="mt-8 text-lg font-medium text-foreground tracking-tight">Host Live Sessions</h3>
                    <p className="mt-5 text-base text-muted-foreground">
              ...
              <div className="pt-6">
                <div className="flow-root bg-card rounded-lg px-6 pb-8 shadow">
                  <div className="-mt-6">
                    ...
                    <h3 className="mt-8 text-lg font-medium text-foreground tracking-tight">Analyze Performance</h3>
                    <p className="mt-5 text-base text-muted-foreground">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              {activeTab === "host" ? (
                ...
                <div className="py-6">
                  ...
                  <div className="mt-6 bg-card shadow sm:rounded-md p-6 text-center">
